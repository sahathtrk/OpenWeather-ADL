...
TestObject requestObject = findTestObject('Object Repository/Get_CurrentAirPollution')
...
double airpolutionLat = jsonResponse.coord.lat
double airpolutionLon = jsonResponse.coord.lon
def tolerance = 0.001
assert Math.abs(geoLat - airpolutionLat) <= tolerance : "Latitude doesn't match"
assert Math.abs(geoLon - airpolutionLon) <= tolerance : "Longitude doesn't match"
